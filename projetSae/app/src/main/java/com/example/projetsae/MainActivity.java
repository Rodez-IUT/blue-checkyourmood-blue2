...
public class MainActivity extends AppCompatActivity {
     ...
     */
    private static final String URL_UTLISATEUR = "http://10.0.2.2:80/API/utilisateur/okjEi8TnWcRvYx2sLz1Qb3uHmAfDpXG";
            ...
            JsonArrayRequest requeteVolley = new JsonArrayRequest(Request.Method.GET,
                    ...
                    new com.android.volley.Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray reponse) {
                            String id;
                            id = setZoneResultatAvecJsonArray(reponse,identifiant,motDePasse);
                            if(id != null){
                                Intent intent = new Intent(MainActivity.this, HomeActivity.class);
                                intent.putExtra("id", id);
                                startActivity(intent);
                            }else{
                                Toast.makeText(MainActivity.this,"mot de passe ou identifiant incorrect", Toast.LENGTH_LONG).show();
                            }
                        }
                    },
     ...
     */
    public String setZoneResultatAvecJsonArray(JSONArray reponse, String identifiant, String motDePasse) {
            ...
            for (int i = 0; i < reponse.length(); i++) {
                ...
                if (objetTypeClient.getString("NOM_UTILISATEUR").equals(identifiant)){
                    if(objetTypeClient.getString("MOT_DE_PASSE").equals(testMdp(motDePasse))){
                        return objetTypeClient.getString("ID_UTILISATEUR");
                    }
                }
            }
            return null;
